...
Invoke-HardeningKitty -Mode HailMary -FileFindingList ./lists/finding_list_cis_microsoft_windows_server_2019_1809_2.0.0_user.csv -SkipRestorePoint
## Running CIS Windows Server Computer Settings
Invoke-HardeningKitty -Mode HailMary -FileFindingList ./lists/finding_list_cis_microsoft_windows_server_2019_1809_2.0.0_computer.csv -SkipRestorePoint
